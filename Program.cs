...
namespace ValidateWaxPK
{
    class Program
    {
        ...
        const string EosMainNetContractName = "greymassnoop";
        const string EosMainNetActionName = "noop";
        ...
        const string EosMainNetChainId = "aca376f206b8fc25a6ed44dbdc66547c36c6c33e3a119ffbeaef943642f0e906";
        const string EosMainNetApiUrl = "http://eos.eosusa.io";
        ...
        {
            bool UseTestNet = false, useWax = false;
            ...
            string ChainId = useWax ? (UseTestNet ? WaxTestNetChainId : WaxMainNetChainId) : EosMainNetChainId;
            string ApiUrl = useWax ? (UseTestNet ? WaxTestNetApiUrl : WaxMainNetApiUrl) : EosMainNetApiUrl;
            ...
            EosSharp.Core.Api.v1.Action req;
            if (useWax)
            {
                req = Abi2CSharp.Contracts.boost_wax.Requests.noop.CreateAction(wallet, new Abi2CSharp.Contracts.boost_wax.Types.noop { });
                if (UseTestNet) req.account = TestNetContractName;
            }
            else
            {
                req = new EosSharp.Core.Api.v1.Action {
                    account = EosMainNetContractName,
                    name = EosMainNetActionName,
                    authorization = new List<PermissionLevel> {
                        new PermissionLevel { actor = wallet, permission = "active" }
                    },
                    data = new { }
                };
            }
